<h1>It seems like you're looking to automate the process of retrieving the database name from a Boolean-based SQL injection vulnerability. Below is a Python script that can assist you in achieving this:
</h1>
